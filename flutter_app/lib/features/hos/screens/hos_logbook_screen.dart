...
class _HosLogbookScreenState extends ConsumerState<HosLogbookScreen> {
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    _buildStatusButton(
                        'sleeper_berth', 'SLEEPER', currentStatus),
                ...
                // Clocks
                const Text('Remaining Time Clocks',
                    style:
  ...
  Widget _buildStatusButton(
      String statusId, String label, String currentStatus) {
  ...
  Widget _buildClockCard(String title, String timeRemaining, bool isWarning) {
    return Card(
      ...
      child: ListTile(
        title: Text(title,
            style: TextStyle(
                color: isWarning ? Colors.deepOrange.shade900 : null)),
        trailing: Text(
          timeRemaining,
          style: TextStyle(
            fontSize: 20,
